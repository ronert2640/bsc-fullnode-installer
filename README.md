...
```
echo "./geth_linux --config ./config.toml --datadir ./mainnet --cache 48000 --rpc.allow-unprotected-txs --txlookuplimit 0 --http --maxpeers 500 --ws --syncmode=snap --snapshot=false --diffsync" > start.sh
chmod +x start.sh
```
